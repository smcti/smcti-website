      ...
      <div className="section-default flex flex-col gap-4 mt-4 text-justify">
        {course.id === "8" || course.id === "9" || course.id === "11" || course.id === "12" ? (
          ...
          <>
            ...
            <p>
              Receber uma Cisco Digital Badge oferece vantagens significativas,
              como a validação oficial de suas habilidades por uma empresa de
              renome global, facilitando a verificação por empregadores e
              fortalecendo sua marca profissional. As badges podem ser
              compartilhadas facilmente em plataformas online, aumentando sua
              visibilidade e credibilidade. Além disso, elas proporcionam
              recomendações personalizadas para novos aprendizados e acesso a
              oportunidades de emprego, ajudando você a se alinhar com outros
              especialistas e se destacar em um mercado de trabalho competitivo.
            </p>
            <p>
              <strong>IMPORTANTE:</strong> Apenas os estudantes que obtiverem
              uma nota igual ou superior a 70% em qualquer tentativa do exame
              final receberão a insígnia digital. Os alunos que já receberam o
              distintivo deste curso em algum momento não o receberão novamente.
            </p>
          </>
        )}
        <button
