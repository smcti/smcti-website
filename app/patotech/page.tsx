...
const featuredCourses = [
  ...
  {
    id: "29",
    image: "/assets/images/cursos/banner_arduino.png",
    title: "Introdução à Robótica com Arduino",
    description:
      "Aprenda os fundamentos da robótica de forma prática. Explore o uso de sensores, atuadores e a programação básica do microcontrolador Arduino desenvolvendo projetos reais e estimulando seu raciocínio lógico.",
    partners: "SMCTI e UTFPR",
    location: "Universidade Técnologica Federal do Paraná (UTFPR)",
    link: "https://www.sympla.com.br/evento/curso-gratuito-introducao-a-robotica-com-arduino-patotech-utfpr/3538663",
    date: "29/08/2026 a 26/09/2026",
    enrollmentDate: "Matrículas abertas",
  ...
  {
    id: "30",
    image: "/assets/images/cursos/banner_python.png",
    title: "Fundamentos de Python",
    description:
      "O ponto de partida ideal para quem quer aprender a programar. Desenvolva a lógica de programação, domine a sintaxe básica de Python, trabalhe com variáveis, estruturas de decisão e laços de repetição através de exercícios práticos.",
    partners: "SMCTI e UTFPR",
    location: "Universidade Técnologica Federal do Paraná (UTFPR)",
    link: "https://www.sympla.com.br/evento/curso-gratuito-fundamentos-de-python-patotech-utfpr/3539121",
    date: "28/08/2026 a 16/10/2026 || 29/08/2026 a 17/10/2026",
    enrollmentDate: "Matrículas abertas",
    startDate: "28/08/2026 e 29/08/2026",
    category: "Programação" as CourseCategory,
    modality: "Presencial" as CourseModality,
