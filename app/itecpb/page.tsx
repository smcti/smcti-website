...
const statsData = [
    ...
    { icon: Building2, value: "+100", label: "Empreendimentos passaram por aqui!", color: "text-indigo-600", bg: "bg-indigo-50", border: "border-indigo-500" },
    { icon: Star, value: "17", label: "Graduadas", color: "text-amber-500", bg: "bg-amber-50", border: "border-amber-500" },
];
