const HeaderLoading = () => {
  return (
    <div className="relative z-0 h-[100dvh] -mt-16 overflow-hidden flex flex-col items-center">
      ...
      <img
        src="/assets/images/coverHeroSmcti.webp"
        alt="Secretaria de Ciencia, tecnologia e inovação vista de cima"
        className="top-0 left-0 min-w-[1920px] h-full scale-100 transform-gpu"
      />
          ...
          <div className="z-20 w-fit glass px-8 py-4 m-4 bg-zircon-50 text-zircon-50 flex sm:flex-row flex-col items-center gap-4">
            <div>
              ...
              <h2 className="text-7xl font-black">
                10<span className="text-2xl"> °C</span>
              </h2>
              <h3 className="h-12 text-center text flex items-center">
                <strong>Sensação:</strong>&nbsp;200
              </h3>
            </div>
            <div className="flex flex-col justify-between h-full">
              <div className="flex flex-row items-center justify-between">
                Carregando<div className="w-12 h-12 mr-[-10%]"></div>
              </div>
              <div className="flex justify-between">
                <strong>Vento: </strong>10 Km/h
              </div>
              <div className="flex justify-between gap-4">
                <strong>Rajada: </strong>10 Km/h
              </div>
              <div className="h-12 text-center text flex items-center justify-between">
                <strong>Humidade:</strong>&nbsp;0%
              </div>
            </div>
          </div>
        </div>
